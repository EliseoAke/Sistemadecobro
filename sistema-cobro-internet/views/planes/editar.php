<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?= BASE_URL ?>planes/editar/<?= $plan['id'] ?>" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descripcion" name="descripcion" rows="3"><?= $plan['descripcion'] ?></textarea>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="velocidad" name="velocidad" value="<?= $plan['velocidad'] ?>" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="precio" name="precio" step="0.01" min="0" value="<?= $plan['precio'] ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1" <?= $plan['activo'] ? 'checked' : '' ?>>
